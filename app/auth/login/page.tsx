      ...
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center relative overflow-hidden"
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-12">
          <div className="mb-6" style={{ height: "130px" }}>
            <img src="/sgbi-logo.png" alt="SGBI" style={{ height: "100%", width: "auto", objectFit: "contain", filter: "drop-shadow(0 0 30px rgba(41,171,226,0.5))" }} />
          </div>
        ...
        <p className="absolute bottom-5 text-white/15 text-xs tracking-widest">© {new Date().getFullYear()} SGBI · Internal Use Only</p>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-xs text-[#29ABE2] hover:text-[#1a96cc] font-medium transition-colors">Forgot password?</Link>
            </div>
            {error && (
          ...
          <div className="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-100">
            <p className="text-xs text-gray-400 text-center">
              New employee?{" "}
              <Link href="/auth/signup" className="text-[#29ABE2] font-semibold hover:text-[#1a96cc] transition-colors">Request access</Link>
