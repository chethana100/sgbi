...
import { Users, Shield, UserCheck, UserX, MoreVertical, Search, CheckCircle2, XCircle, Clock } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400">Manage user access and approvals</p>
      </div>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-3">
                        <Avatar className="h-8 w-8">
                          <AvatarFallback className="bg-[#29ABE2]/10 text-[#29ABE2] text-xs">
